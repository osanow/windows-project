...
export const APP_START_FETCHING_ITEMS = 'APP_START_FETCHING_ITEMS';
export const APP_FETCH_ITEMS = 'APP_FETCH_ITEMS';
...
export const APP_START_HIDING = 'APP_START_HIDING';
